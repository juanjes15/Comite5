...
<body class="text-gray-800 antialiased">
    <!--Nav-->
    <header>
        <nav class="top-0 absolute z-50 w-full px-4 lg:px-6 py-2.5">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <img src="{{ asset('img/icon.png') }}" class="mr-3 h-12 sm:h-12" alt="CODES" />
                <div class="flex items-center lg:order-2">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}"
                                class="text-white text-l font-semibold bg-green-700 hover:bg-green-900 focus:ring-4 focus:ring-cyan-800 rounded-lg px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">
                                Dashboard</a>
                        @else
                            <a href="{{ route('login') }}"
                                class="text-white text-l font-semibold bg-green-700 hover:bg-green-900 focus:ring-4 focus:ring-cyan-800 rounded-lg px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">
                    ...
                    <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                        <div class="pr-12">
                            <h1 class="text-white font-semibold text-5xl">
                                Comité de Evaluación y Seguimiento - CODES
                            </h1>
                            <p class="mt-4 text-lg text-gray-300">
                                Página web para la gestion completa de los comites de evaluación y seguimiento en la
                                Regional
                                Caldas
                            </p>
                        </div>
