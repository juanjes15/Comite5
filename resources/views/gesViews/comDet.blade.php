<x-app-layout>
    <x-slot name="header">
        <h2 class="leading-tight">
            {{ __('Detalles del comité #') . $comite->id . ' - Instructor: ' . $comite->solicitud->aprendizs[0]->ficha->instructor->ins_nombres . ' ' . $comite->solicitud->aprendizs[0]->ficha->instructor->ins_apellidos }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-mint1 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-4 py-4">
                    ...
                    <div class="bg-sena-100 p-6 rounded-lg mb-6">
                        <h1 class="mb-2 text-lg font-semibold">Instructores involucrados</h1>
                    ...
                    <div class="bg-sena-100 p-6 rounded-lg mb-6">
                        <h1 class="mb-2 text-lg font-semibold">Aprendices involucrados</h1>
                        <table class="w-full text-sm text-left">
                            <thead class="text-xs text-gray-700 uppercase bg-mint2">
                                <tr>
                                    <th scope="col" class="px-6 py-3">
