            ...
            <div class="bg-gray2 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex items-center justify-between m-4">
                        <form action="{{ route('gesViews.comAls') }}" method="get" class="flex-grow ml-4">
                            ...
                            @forelse ($comites as $comite)
                                <tr class="border-b">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <x-link2 title="Detalles" href="{{ route('gesViews.comSes', $comite) }}">
                            ...
                            @empty
                                <tr class="bg-white border-b">
                                    <td colspan="5" class="px-6 py-4 whitespace-nowrap">
                                        {{ __('No se encontraron comites en sesion') }}
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
