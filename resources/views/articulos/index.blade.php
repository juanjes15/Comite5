<x-app-layout>
    <x-slot name="header">
        <h2 class="leading-tight">
            {{ __('CRUD para los Articulos del Reglamento') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12 text-black font-medium">
            ...
            <div class="bg-gray2 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex items-center justify-between m-4">
                        <x-link href="{{ route('articulos.create') }}" class="m-4">Agregar artículo</x-link>
                        <form action="{{ route('articulos.index') }}" method="get" class="flex-grow ml-4">
                            ...
                            <div class="relative">
                                ...
                                <input name="q" type="search" id="default-search"
                                    placeholder="Buscar por capítulo, número o descripción del artículo"
                            ...
                            @forelse ($articulos as $articulo)
                                <tr class="border-b">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <x-link2 title="Editar" href="{{ route('articulos.edit', $articulo) }}">
                                        ...
                                        <form method="POST" action="{{ route('articulos.destroy', $articulo) }}"
                                            ...
                                            <x-danger-button type="submit" title="Eliminar"
                                                onclick="return confirm('¿Está seguro de eliminar el artículo {{ $articulo->art_numero }}?')">
        ...
        <br>
        {!! $articulos->appends(['q' => request()->input('q')])->links() !!}
    </div>
</x-app-layout>
