        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-4 py-4">
                    ...
                    <form method="POST" action="{{ route('pruebas.update', $prueba) }}">
                        @csrf
                        @method('PUT')
                        <div>
                        ...
                        <div>
                            ...
                            <x-input id="pru_url" class="block mt-1 w-full" type="text" name="pru_url"
                                :value="$prueba->pru_url" required autofocus autocomplete="pru_url" />
                        </div>
                        <div>
                            ...
                            <select name="sol_id"
                                ...
                                @foreach ($solicitudComites as $solicitudComite)
                                    @if ($solicitudComite->id == $prueba->sol_id)
                                        <option selected value="{{ $solicitudComite->id }}">
