                    ...
                    <form method="POST" action="{{ route('comites.store') }}">
                        ...
                        <div>
                            ...
                            <x-input id="com_acta" class="block mt-1 w-full" type="text" name="com_acta"
                                :value="old('com_acta')" required autofocus autocomplete="com_acta" />
                        </div>
                        <div>
                            <x-label for="com_estado" value="{{ __('Estado') }}" />
                            <x-input id="com_estado" class="block mt-1 w-full" type="text" name="com_estado"
                                :value="old('com_estado')" required autofocus autocomplete="com_estado" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <x-input id="com_recomendacion" class="block mt-1 w-full" type="text"
                                name="com_recomendacion" :value="old('com_recomendacion')" required autofocus
                                autocomplete="com_recomendacion" />
                        </div>
                        <div>
