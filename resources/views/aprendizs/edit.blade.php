                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-4 py-4">
                    ...
                    <form method="POST" action="{{ route('aprendizs.update', $aprendiz) }}">
                        ...
                        <div>
                            ...
                            <x-input id="apr_identificacion" type="text" name="apr_identificacion" :value="$aprendiz->apr_identificacion"
                                required autofocus autocomplete="apr_identificacion" />
                        </div>
                        <div>
                            <x-label for="apr_nombres" value="{{ __('Nombres') }}" />
                            <x-input id="apr_nombres" type="text" name="apr_nombres" :value="$aprendiz->apr_nombres" required
                                autofocus autocomplete="apr_nombres" />
                        </div>
                        <div>
                            <x-label for="apr_apellidos" value="{{ __('Apellidos') }}" />
                            <x-input id="apr_apellidos" type="text" name="apr_apellidos" :value="$aprendiz->apr_apellidos" required
                                autofocus autocomplete="apr_apellidos" />
                        </div>
                        <div>
                            <x-label for="apr_email" value="{{ __('Email') }}" />
                            <x-input id="apr_email" type="text" name="apr_email" :value="$aprendiz->apr_email" required autofocus
                                autocomplete="apr_email" />
                        </div>
                        <div>
                            <x-label for="apr_telefono" value="{{ __('Telefono') }}" />
                            <x-input id="apr_telefono" type="text" name="apr_telefono" :value="$aprendiz->apr_telefono" required
                                autofocus autocomplete="apr_telefono" />
                        </div>
                        <div>
                            <x-label for="apr_direccion" value="{{ __('Direccion') }}" />
                            <x-input id="apr_direccion" type="text" name="apr_direccion" :value="$aprendiz->apr_direccion" required
