                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-4 py-4">
                    ...
                    <form method="POST" action="{{ route('insViews.updInf', $solicitud) }}">
                        ...
                        <div>
                            ...
                            <x-input id="created_at" type="datetime-local" name="created_at" :value="$solicitud->created_at" required
                    ...
                    <h1 class="mb-2 mt-6 text-lg font-semibold">Instructores involucrados en esta solicitud</h1>
                    ...
                    <x-link class="mx-3 mb-6" href="{{ route('insViews.revIns', $solicitud) }}">
                        Editar Instructores Involucrados</x-link>

                    <h1 class="my-2 text-lg font-semibold">Aprendices involucrados en esta solicitud</h1>
                    <table class="w-full text-sm text-left">
                        <thead class="text-xs text-gray-700 uppercase bg-mint2">
                            <tr>
                                <th scope="col" class="px-6 py-3">
                    ...
                    <x-link class="mx-3 mb-6" href="{{ route('insViews.revApr', $solicitud) }}">
                        Editar Aprendices Involucrados</x-link>

                    <h1 class="my-2 text-lg font-semibold">Normas infringidas en esta solicitud</h1>
                    <h2 class="mt-6 mb-2 font-semibold">Artículos infringidos</h2>
                    <table class="w-full text-sm text-left">
                        <thead class="text-xs text-gray-700 uppercase bg-mint2">
                            <tr>
                                <th scope="col" class="px-6 py-3">
                    ...
                    <x-link class="mx-3 mb-6" href="{{ route('insViews.revFal', $solicitud) }}">
